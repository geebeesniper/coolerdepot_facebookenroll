...
$bulkpartial=$read('app/Views/sales/_bulk_submit_form.php');
...
$check(strpos($view,'id="saveWaitButton"')!==false&&(strpos($view,'id="bulkSubmitToggle"')!==false||strpos($bulkview,'id="bulkQueueButton"')!==false||strpos($bulkpartial,'id="bulkQueueButton"')!==false),'Sales UI exposes Save & Wait + Bulk Submit');
