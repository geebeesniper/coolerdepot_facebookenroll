...
$s=Database::connection()->prepare("INSERT INTO users(sales_id,username,password_hash,display_name,role,active,created_at,updated_at)
...
fclose($h);
echo "Imported/updated {$n} sales users. Accounts remain disabled until password assignment.\n";
