<?php
/**
 * File / 文件：app/Views/admin/dashboard.php
 * EN: Renders the admin/dashboard application view template.
 * 中文：渲染应用视图模板 admin/dashboard。
...
<div class="page-head sales-portal-head admin-page-head admin-dashboard-title-head admin-activity-head">
    <div class="admin-dashboard-heading">
        ...
        <p class="sales-portal-subtitle" data-dashboard-i18n="dashboardSubtitle">Review Sales posting activity, Post Review, and Sales Review status.</p>
    </div>
