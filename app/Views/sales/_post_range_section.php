<?php
/**
 * File / 文件：app/Views/sales/_post_range_section.php
 * EN: Renders the sales/_post_range_section application view template.
 * 中文：渲染应用视图模板 sales/_post_range_section。
