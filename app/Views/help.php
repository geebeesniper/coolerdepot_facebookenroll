...
(function(){
    ...
    const staticTranslations={
        'zh-CN':{
            ...
            'Submit':'提交','Submit Post':'提交 Post','+ Submit Post':'+ 提交 Post','Check Post':'检查 Post','Save Verified Post':'保存已验证 Post',
            ...
            'Paste the listing URL':'粘贴 Listing URL','Click Check Post':'点击 Check Post','Click Save Verified Post':'点击 Save Verified Post',
            'Open Submit Marketplace Post':'打开 Submit Marketplace Post','Read Verification Result':'读取验证结果','Track Review':'查看 Review',
            ...
            'Sales Rating':'Sales Rating','Daily Sales Review':'Daily Sales Review','Target met':'已达到目标','Add Note':'添加 Note','Save Review':'保存 Review',
        ...
        'zh-TW':{
            ...
            'Submit':'提交','Submit Post':'提交 Post','+ Submit Post':'+ 提交 Post','Check Post':'檢查 Post','Save Verified Post':'儲存已驗證 Post',
            ...
            'Paste the listing URL':'貼上 Listing URL','Click Check Post':'點擊 Check Post','Click Save Verified Post':'點擊 Save Verified Post',
            'Open Submit Marketplace Post':'打開 Submit Marketplace Post','Read Verification Result':'讀取驗證結果','Track Review':'查看 Review',
            'Back to today':'返回今天','All':'全部','Unreviewed':'未審核','Weekly':'每週','Monthly':'每月','Custom':'自訂',
            '1 Day':'1 天','3 Days':'3 天','Good':'Good','Bad':'Bad','Sales':'Sales','Sales Review':'Sales Review','Post Review':'Post Review',
            'Sales Rating':'Sales Rating','Daily Sales Review':'Daily Sales Review','Target met':'已達到目標','Add Note':'新增 Note','Save Review':'儲存 Review',
